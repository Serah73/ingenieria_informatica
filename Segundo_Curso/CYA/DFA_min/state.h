...
//// Set's
	...
	void set_id( int );
	void set_state( int );
	void set_transition( std::vector< transition_t > );
	void set_push_transition( transition_t );
...
/** @brief obtener a que estado va consumiendo el char
 * 
 *  @param char simbolo a consumir para comprobara que estado va
 * 
 *  @return estado al que transita con el char
 */
